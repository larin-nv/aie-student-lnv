...
def compute_quality_flags(summary: DatasetSummary, missing_df: pd.DataFrame, min_missing_share = 0.05) -> Dict[str, Any]:
    """
    ...
    - проверка на выход колонки за порог доли пропусков
    """
    flags: Dict[str, Any] = {}
    ...
    # Проверка на выход колонки за порог доли пропусков
    high_missing_columns = missing_df[missing_df["missing_share"] > min_missing_share].index.tolist()
